...
const useScript = hash => {
    useEffect(() => {
        ...
        // script.src = ('https:' === document.location.protocol ? 'https://' : 'http://') + 'secure.wufoo.com/scripts/embed/form.js';
        ...
        //     try {
        //         s1djprkt15w5sbl = new WufooForm();
        //         s1djprkt15w5sbl.initialize(options);
        //         s1djprkt15w5sbl.display();
        //     } catch (e) { }
        // };
...
const WufooForm = () => {
    ...
    this.generateFrameMarkup = function () { 
        ...
        var src = '<iframe title="Embedded Wufoo Form" id="wufooForm' + this.formHash + '" class="wufoo-form-container" height="' + this.height + '" allowTransparency="true" frameborder="0" scrolling="' + scroll + '" style="width:' + this.width + ';border:none"' + 'src="' + this.frameUrl + '"><a href="' + this.generateFullPageUrl() + '" title="html form">Fill out my Wufoo form!</a></iframe>'; 
        return src 
    }, 
    ...
    this.isMessageFromCorrectForm = function (dataHash) { 
        ...
        this.attachOnResizeEvent = function () { 
            if (typeof window.__wufooForms != "undefined") {
                ...
                window.__wufooForms = []; window.__wufooForms.push(this); 
